    ...
    try {
        ...
        const updatedRequisition = await prisma.purchaseRequisition.update({
            ...
            data: {
                ...
                cpoAmount: cpoAmount,
                rfqSettings: { ...(rfqSettings || {}), masked: true, method: procurementMethod || (rfqSettings && rfqSettings.method) || 'RFQ' },
                procurementMethod: procurementMethod || (rfqSettings && rfqSettings.method) || 'RFQ',
            }
        });
