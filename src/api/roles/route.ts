...
export async function POST(request: Request) {
  try {
    ...
    const { name, description, actorUserId } = body as { name: string, description: string, actorUserId: string };
...
export async function PATCH(request: Request) {
   try {
    const body = await request.json();
    const { id, name, description, actorUserId } = body as { id: string, name: string, description: string, actorUserId: string };
