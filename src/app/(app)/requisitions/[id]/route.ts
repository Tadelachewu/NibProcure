...
export async function GET(
  ...
  try {
    ...
    const formatted = {
        ...
        rfqSettings: requisition.rfqSettings ? JSON.parse(requisition.rfqSettings) : {},
        allowedVendorIds: requisition.allowedVendorIds ? requisition.allowedVendorIds.split(',') : [],
        awardedQuoteItemIds: requisition.awardedQuoteItemIds ? requisition.awardedQuoteItemIds.split(',') : [],
