...
export async function GET(request: Request) {
  ...
  try {
    ...
    // Fetch all matching requisitions (without attempting unsupported
    // JSON[] filters in Prisma), then apply per-item JSON array filtering in
    // JS for vendor-specific views. Paginate after filtering to return the
    // correct slice and count.
