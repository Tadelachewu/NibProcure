                             ...
                             <CardContent>
                                <Accordion type="single" collapsible className="w-full">
                                    <AccordionItem value="item-bids">
                                        <AccordionTrigger>View Item Bid Details</AccordionTrigger>
                            ...
                            <AccordionItem value={item.itemName} key={item.itemName}>
                                <AccordionTrigger>
                                    <div className="flex w-full justify-between items-center pr-4">
                                        ...
                                        {item.winner && 
                                            <span className="text-sm font-normal text-muted-foreground">Winner: <span className="font-semibold text-primary">{item.winner.vendorName}</span></span>
                                        }
                                    </div>
                                </AccordionTrigger>
